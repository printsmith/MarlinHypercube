...
#define CUSTOM_MACHINE_NAME "Ty's Hypercube"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 141.79
  #define  DEFAULT_bedKi 27.92
  #define  DEFAULT_bedKd 180.03
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION X_MIN_POS + 5 + PROBE_BED_INSET
  #define RIGHT_PROBE_BED_POSITION X_MAX_POS - 5 - PROBE_BED_INSET
  #define FRONT_PROBE_BED_POSITION Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER + PROBE_BED_INSET
  #define BACK_PROBE_BED_POSITION Y_MAX_POS - Y_PROBE_OFFSET_FROM_EXTRUDER - PROBE_BED_INSET
